<template>
    <div>
                ...
                <el-form ref="filters" :model="filters" label-width="80px">
                    <el-row :gutter="20">
                        ...
                        <el-col :span="18" style="display: flex;justify-content: space-between">
                            ...
                            <el-button type="primary" style="width: 140px;background: #5f8eff;margin-left: 18px"
                                       @click="tableOperate('add')">创建危化品目录
                            </el-button>
                        </el-col>
                    </el-row>
                </el-form>
                ...
                <el-row :gutter="20">
                    ...
                    <el-col :span="5">
                        <el-form-item label="CAS编号：" prop="cas">
                            <el-input v-model="addForm.cas" placeholder="请输入CAS编号"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="5">
                        <el-form-item label="别名：" prop="alias">
                            <el-input v-model="addForm.alias" placeholder="请输入别名"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="5">
        ...
        <el-card style="margin: 14px;" v-if="editFormVisible">
            ...
            <el-form :model="editForm" label-width="120px" ref="editForm">
                <el-row :gutter="20">
                    ...
                    <el-col :span="5">
                        <el-form-item label="CAS编号：" prop="cas">
                            <el-input v-model="editForm.cas" placeholder="请输入CAS编号"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="5">
                        <el-form-item label="别名：" prop="alias">
                            <el-input v-model="editForm.alias" placeholder="请输入别名"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="5">
                        <el-form-item label="备注：" prop="remark">
        ...
        <el-table :data="riskChemicalList" class="wxtable" stripe>
            <el-table-column
                    type="index"
            ...
            <el-table-column prop="cas" label="CAS编号" width="250" align='center'>
            </el-table-column>
            <el-table-column prop="alias" label="别名" width="250" align='center'>
            </el-table-column>
        ...
        <div class="page-floor" v-if="riskChemicalPage.count > riskChemicalPage.rows">
            ...
            <div>
                ...
                <el-pagination
                        ...
                        :page-size="riskChemicalPage.rows"
                        layout="total, sizes, prev, pager, next, jumper"
                        :total="riskChemicalPage.count">
                </el-pagination>
            </div>
        </div>
    </div>
...
<script>
    import rishChemicalListCmmBus from './rishChemicalListCmmBus.js'

    export default rishChemicalListCmmBus
