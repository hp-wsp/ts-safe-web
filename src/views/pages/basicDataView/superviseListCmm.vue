<template>
    <div>
        ...
        <el-table :data="superviseList" class="wxtable" stripe>
            <el-table-column
                    type="index"
        ...
        <div class="page-floor" v-if="supervisePage.count > supervisePage.rows">
            ...
            <div>
                ...
                <el-pagination
                        ...
                        :page-size="supervisePage.rows"
                        layout="total, sizes, prev, pager, next, jumper"
                        :total="supervisePage.count">
                </el-pagination>
            </div>
        </div>
    </div>
...
<script>
    import superviseListCmmBus from './superviseListCmmBus.js'

    export default superviseListCmmBus
